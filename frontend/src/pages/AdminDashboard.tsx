import { Activity, CheckCircle2, Clock, GraduationCap, LibraryBig, ShieldX, Users } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
        ...
        <StatCard title="Approved Users" value={stats.approvedUsers ?? 0} icon={CheckCircle2} accent="bg-mint/20 text-teal-700" />
        <StatCard title="Rejected Users" value={stats.rejectedUsers ?? 0} icon={ShieldX} accent="bg-slate-200 text-slate-700 dark:bg-white/10" />
      </div>
      <div className="card">
